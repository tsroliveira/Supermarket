                          ...
                          <tr>
                            ...
                            <form class="form-horizontal" action="cartadd" method="post">
                              ...
                              <td>
                                ...
                                ?>
                                <button type="submit" class="btn btn-outline-success btn-sm rounded"><i class="fa fa-plus-circle"></i> Add</button>
                              </td>
                            </form>
                          </tr>
                        <?php
