                            ...
                            if ($ok == ""){
                              ?>
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-8 col-sm-8 ">
                                    Username
                                    <input type="text" id="username" name="username" required="required" class="form-control " value="<?php echo !empty($response->username)?$response->username: '';?>">
                                  </div>
                                </div>
                                <div class="form-group row">
                                  <div class="col-md-2 col-sm-2 "></div>
                                  <div class="col-md-4 col-sm-4 ">
                                    Password
                                    <input type="password" id="password" name="password" required="required" class="form-control " value="<?php echo !empty($response->password)?$response->password: '';?>">
                                  </div>
                                  <div class="col-md-4 col-sm-4 ">
                                    Profile                              
                                    <select class="form-control text-secondary" id="profile" name="profile" required="required">
                                      <option value="<?php echo !empty($response->profile)?$response->profile: '';?>"> <?php echo !empty($response->profile)?$response->profile: '';?> </option>
