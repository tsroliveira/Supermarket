              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a class="#"></a></li>
                    <li><a class="#"></a></li>
                    <li><a href="taxesadd" class=""><img src="./view/src/img/supermarket-plus.svg" class="avatar2" alt="Avatar2"></a></li>
                  ...
                  <table id="datatable" class="table table-striped" style="width:100%">
                    ...
                    <tbody>
                      ...
                      foreach ($response->response as $row) {
                        ?>
                          <tr>
                            <th scope="row"><img src="./view/src/img/supermarket-shopping-cart.svg" class="avatar2" alt="Avatar2"></th>
                            <td><?php echo $row->taxe ?></td>
                            <td><i class="fa fa-calendar text-dark"></i> <?php echo $row->description ?></td>
                            <td><i class="fa fa-calendar text-dark"></i> <?php echo $row->value ?></td>
                            <td><i class="fa fa-child text-dark"></i> Active </td>
                            <td>
                              <a href="/taxesupd?id=<?php echo $row->id ?>" class="btn btn-outline-success btn-sm"><i class="fa fa-pencil"></i> Edit </a>
                              <a href="/taxesdel?id=<?php echo $row->id ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i> Delete </a>                              
                            </td>
                          </tr>
                        <?php
                      }
