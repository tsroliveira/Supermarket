              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content"><!-- Smart Wizard -->
                    <form class="form-horizontal form-label-left" action="taxesupd?id=<?php echo $id;?>" method="post" enctype="multipart/form-data">
                              ...
                              ?>
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-8 col-sm-8 ">
                                    Taxe Name
                                    <input type="text" id="taxe" name="taxe" required="required" class="form-control  " value="<?php echo !empty($response->taxe)?$response->taxe: '';?>">
                                ...
                                <div class="form-group row">
                                  ...
                                  <div class="col-md-4 col-sm-4 ">
                                    Status                              
                                    <select class="form-control text-secondary" id="status" name="status" required="required">
                                      <option value="<?php echo !empty($response->status)?$response->status: '';?>"> <?php echo !empty($response->status)?$response->status: '';?> </option>
