              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content"><!-- Smart Wizard -->
                    <?php echo $msg;?>
                    <?php echo $ok;?>
                    <form class="form-horizontal form-label-left" action="taxesadd" method="post" enctype="multipart/form-data">
                      <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <div id="step-1">
                          <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8 ">
                              Taxe Name 
                              <input type="text" id="taxe" name="taxe" required="required" class="form-control  ">
                            </div>
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
                        ...
                        <div id="step-2">
                          <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8 ">
                              Taxe Value 
                              <input type="text" id="value" name="value" required="required" class="form-control  " required>
                            </div>
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
