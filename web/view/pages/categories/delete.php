                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div id="demo-form2" class="form-horizontal form-label-left">
                      <?php 
                        if(!empty($_POST)) {
                          echo '<a href="typelist" type="btn" class="btn btn-success">Back</a>';
                        }
                        else {
                          ?>
                            <form class="form-horizontal" action="typedel?id=<?php echo $id?>" method="post">
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                  Sector
                                  <input id="sector" name="sector" class="form-control col" type="text" value="<?php echo !empty($response->sector)?$response->sector: '';?>" readonly>
                                </div>
                              </div>  
                              <div class="form-group row">
                                <div class="col-md-2 col-sm-2 "></div>
                              ...
                              <div class="form-group row">
                                ...
                                <div class="col-md-8 col-sm-8 ">
                                  <div class="form actions">
                                    ...
                                    <a href="typelist" type="btn" class="btn btn-default">No</a>
                                  </div>
                                </div>
                              </div>
                            </form>
