              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <li><a class="#"></a></li>
                    <li><a class="#"></a></li>
                    <li><a href="productadd" class=""><img src="./view/src/img/supermarket-plus.svg" class="avatar2" alt="Avatar2"></a></li>
                      ...
                      foreach ($response->response as $row) {
                        ?>
                          <tr>
                            ...
                            <td><i class="fa fa-cutlery"></i> <?php echo $row->quantity ?></td>
                            <td>
                              <i class="fa fa-tag"></i> 
                              <?php 
                                $curl = curl_init();
                            ...
                            <td>
                              <a href="/productupd?id=<?php echo $row->id ?>" class="btn btn-outline-success btn-sm"><i class="fa fa-pencil"></i> Edit </a>
                              <a href="/productdel?id=<?php echo $row->id ?>" class="btn btn-outline-danger btn-sm"><i class="fa fa-trash"></i> Delete </a>                              
                            </td>
                          </tr>
                        <?php
                      }
