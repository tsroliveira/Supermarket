              ...
              <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                  ...
                  <div class="x_content"><!-- Smart Wizard -->
                    <?php echo $msg;?>
                    <?php echo $ok;?>
                    <form class="form-horizontal form-label-left" action="productadd" method="post" enctype="multipart/form-data">
                      <div id="wizard" class="form_wizard wizard_horizontal">
                        ...
                        <div id="step-2">
                          <div class="form-group row">
                            ...
                            <div class="col-md-8 col-sm-8 ">
                              Quantity 
                              <input type="text" id="quantity" name="quantity" required="required" class="form-control  " required>
                            </div>
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-2 col-sm-2"></div>
                            <div class="col-md-8 col-sm-8">
